...
coe = rep(0,di)
coe[1:5] = 2
res_1_50 = DoSims(50,Nte,coe,sig,R=20,grid,rho)

# lasso peforms much better

# example 2: many small non-zero coefficients
...
# example 3: all coefficient are non-zero
...
# homework: play around with this to get ebtter idea of overall performance
